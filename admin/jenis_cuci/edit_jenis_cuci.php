...
$jenis_cuci = query("SELECT * FROM jenis_cuci WHERE id = $id")[0];

if (isset($_POST["submit"])) {
    if (edit_jenis_cuci($_POST) > 0) {
        echo "<script>
...
<body>
            ...
            <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../info_perusahaan/info_perusahaan.php">Info Perusahaan</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <!-- Form Edit Jenis Cuci -->
    <div class="card" style="width: 90%;">
        <div class="card-header">
            <h3>Edit Jenis Cuci</h3>
        </div>
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?= $jenis_cuci["id"]; ?>">
                <div class="mb-3">
                    <label for="jenis_cuci" class="form-label">Jenis Cuci</label>
                    <input type="text" name="jenis_cuci" id="jenis_cuci" class="form-control" placeholder="Enter Jenis Cuci" value="<?= $jenis_cuci["jenis_cuci"]; ?>" required>
                </div>
                <div class="mb-3">
                    <label for="harga" class="form-label">Harga</label>
                    <input type="number" name="harga" id="harga" class="form-control" placeholder="Enter Harga" value="<?= $jenis_cuci["harga"]; ?>" required>
                </div>
