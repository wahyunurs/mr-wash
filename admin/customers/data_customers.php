...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <!-- Tambah Data -->
            <!-- <button type="button" class="btn btn-primary"><a href="tambah_data_customers.php">Tambah Data</a></button>
            <br><br> -->
                ...
                <tbody>
                    ...
                    <?php foreach ($data_customers as $row) : ?>
                        <tr>
                            ...
                            <td><?= $row["email"]; ?></td>
                            <td>
                                <button type="button" class="btn btn-warning"><a href="edit_data_customers.php?id=<?= $row["id"]; ?>">Edit</a></button>
                                <button type="button" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"><a href="delete_data_customers.php?id=<?= $row["id"]; ?>">Delete</a></button>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
