...
<body>
    ...
    <!-- Tabel Data Pendaftaran Antrian -->
    <div class="card">
        <div class="card-header">
            <h3>Data Pendaftaran Antrian</h3>
        </div>
        <div class="card-body">
            <!-- Tambah Data -->
            <!-- <button type="button" class="btn btn-primary"><a href="tambah_pesanan.php">Tambah Data</a></button>
            <br><br> -->
                ...
                <tbody>
                    <?php foreach ($pendaftaran as $row) : ?>
                        ...
                        <tr>
                            ...
                            <td><?= $row["status_cuci"]; ?></td>
                            <td>
                                <button type="button" class="btn btn-warning"><a href="edit_pesanan.php?id=<?= $row["id"]; ?>">Edit</a></button>
                                <!-- Link href delete pesanan -->
                                <!-- delete_pesanan.php?id=<?= $row["id"]; ?> -->
