        ...
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="merk_mobil" id="merk_mobil" class="form-control" placeholder="Enter Merk Mobil" value="<?= $pendaftaran["merk_mobil"]; ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="time" name="jam_cuci" id="jam_cuci" class="form-control" placeholder="Enter Jam Cuci" value="<?= $pendaftaran["jam_cuci"]; ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="status_cuci" class="form-label">Status Cuci</label>
                    <select name="status_cuci" id="status_cuci" class="form-select" required>
                        <option>Pilih Status Cuci</option>
                        <option type></option>
